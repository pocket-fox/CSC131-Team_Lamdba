...
var StartState = {
    ...
    create: function () {
        ...
        this.a11y = A11yKit.init({
            ...
            live: 'polite',
            onEnable: function () {
                self.a11y.announce('Game focused.');
            },
            onDisable: function () {
                self.a11y.announce('Game focus released');
            }
        });


        this.game.canvas.addEventListener('focus', function () {
    ...
    shutdown: function () {
        ...
        if (this.domElements) {
            A11yKit.destroyDomOverlays(this.domElements);
    ...
    playButtonActions: {
        onClick: function () {
            AudioManager.playSound("bloop_sfx", this);
            if (lastState && lastState !== "TitleState" && lastState !== "StartState") {
                this.state.start(lastState);
            } else {
