...
var IntroState = {
    ...
    create: function () {
        ...
        // when pressed, call the same function as the button
        // also debug message
        this.spaceKey.onDown.add(function () {
            console.log("Space pressed!");
            if (this.nextButton.visible) {
                console.log("Next button is visible, calling onClick");
                this.nextButtonActions.onClick.call(this);
            } else {
                console.log("Next button NOT visible yet");
            }
        }, this);
        ...
        self.a11y.announce(speechText1)
